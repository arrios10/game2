...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func backToMenuWithDelay() {
        ...
        let transitionAction = SKAction.run { [weak self] in
            ...
            // Reset to daily mode if was in random mode
    ...
    func endGame() {
        ...
        // Only save scores in daily mode
        if Settings.sharedInstance.currentGameMode == .daily && Settings.sharedInstance.playedToday == false {
